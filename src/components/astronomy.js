...
function SunClass() {
    ...
    this.EclipticCartesianCoordinates = function () {
        return new CartesianCoordinates(0.0, 0.0, 0.0);
    };

    this.EclipticAngularCoordinates = function () {
...
function EarthClass() {
    ...
    this.GeocentricCoordinates = function () {
        return new CartesianCoordinates(0.0, 0.0, 0.0);
    };

    this.EquatorialCoordinates = EqCoords;

    this.DistanceFromEarth = function () {
...
PlanetPS.prototype.Perturb = function (xh, yh, zh) {
...
function PerturbEclipticLatitude_Jupiter() {
    return 0.0;
}
...
function PerturbEclipticLatitude_Uranus() {
    return 0.0;
}
...
function AstronomyClass() {
    ...
    this.EclipticLatLon = function (x, y, z) {
        return {
            'longitude': Angle.AtanDeg2(y, x),
            'latitude': Angle.AtanDeg2(z, Math.sqrt(x * x + y * y))
        };
    };
...
function Astronomy_AngularRadius(body, day) {
...
function Astronomy_MoonApogee(body, day1, day2) {
...
function Astronomy_MoonPerigee(body, day1, day2) {
    // The parameters 'body', 'location', 'otherBody' are all unused.
    // Return true if Moon is at greatest distance from Earth.
